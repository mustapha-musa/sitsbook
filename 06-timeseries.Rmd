...
P: De acordo com usar "time series tibble", mas tem a questao tambem de que os capitulos
anteriores ja usavam tibble, mas a definicao do que e' uma tibble aparece no capitulo 3
e neste. como o capitulo 3 e' introdutorio acho que pode ficar em dois lugares, mas a
definicao que esta aqui poderia vir antes.
Exemplo: "04-datacubes.Rmd:The result of `sits_cube()` is a tibble"
-->
