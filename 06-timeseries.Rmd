...
<!---
PEDRO: 12) O trecho abaixo apresenta tibble, termo que ja foi usado em varios outros capitulos. acho que poderia mover parte deste paragrafo mais para o comeco do livro. O restante deste capitulo fala bastante de "sits tibble", nao sei se e' a melhor estrategia uma vez que varios outros objetos no
...
```
<!---
PEDRO: 14) No exemplo acima, o ultimo argumento sits_get_data e' seguido de fecha parenteses. tem outros exemplos que o fecha parenteses fica sozinho na linha seguints. seria bom manter consistencia. prefiro deste jeito, pois economiza espaco.
-->
...
<!---
PEDRO: 15) gostaria de confirmar se MERIS NDVI poderia ser apenas NDVI. O termo MERIS so' aparece uma vez em todo o livro.
-->
...
<!---
PEDRO: 16) esta ultima frase nao ficou boa, a ainda usa o termo "users". remover?
-->
...
<!---
PEDRO: 17) pessoalmente nao gosto de aspas nestas situacoes. poderia substituir por italico? tem outras situacoes assim no texto
-->
...
<!---
PEDRO: 18) as duas frases acima poderiam estar no paragrafo anterior
-->
