...
<!--
PEDRO: Me parece que este capitulo e o anterior (Visualising and exporting data) poderiam ser um unico capitulo. Inclusive, o capitulo anterior comeca com "This Chapter is intended for programmers and experts  who would like to extend the capabilities of `sits` by including [...] **machine learning algorithms**, [...]"). O capitulo anterior tambem tem um numero de palavras consideravelmente menor do que os demais capitulos (so' e' maior do que o 01-setup.Rmd):

   454 01-setup.Rmd
   846 02-acknowledgements.Rmd
  2652 03-intro.Rmd
  3260 04-datacubes.Rmd
  2126 05-cubeoperations.Rmd
  2054 06-timeseries.Rmd
  4129 07-clustering.Rmd
  6892 08-machinelearning.Rmd
  2653 09-rasterclassification.Rmd
  3044 10-bayesiansmoothing.Rmd
  2673 11-validation.Rmd
  2513 12-uncertainty.Rmd
  1188 13-ensembleprediction.Rmd
=> 491 14-visualization.Rmd
  1869 15-annex.Rmd
     2 16-references.Rmd
   574 index.Rmd
 37420 total
...
<!--
PEDRO: behavior ou behaviour (abaixo)? O livro tem varias ocorrencias das duas palavras
-->
