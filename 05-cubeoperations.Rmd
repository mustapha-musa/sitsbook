...
<!---
PEDRO: 10) Aqui tem uma questao. Todas as bandas ate entao eram descritas entre aspas. Agora nao esta entre aspas porque o usuario faz a formulacao usando as bandas como se fossem variaveis. E' importante deixar isto claro, mas estou mantendo entre aspas no texto porque na maioria dos lugares esta assim.
GILBERTO: Vamos tirar as aspas to texto.
-->
